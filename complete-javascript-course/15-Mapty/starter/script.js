...
//topic : Refactoring for Project Architecture
class App{
    #map;
    #mapEvent;
    #mapZoomLevel = 13;
    ...
    _newWorkout(e){
        ...
        let workout;
        //subtopic : if workout running, create running object
        if(type === 'running'){
            const cadence = +inputCadence.value;
            //subtopic : check if data is valid
        ...
        //subtopic : if workout cycling, create cycling object
        if(type === 'cycling'){
        ...
        //subtopic : render workout on list
    ...
    _renderWorkoutMarker(workout){
        ...
        })).setPopupContent(`${workout.type === 'running' ? '🏃‍♂':'🚴‍'} ${workout.discription}`).openPopup();
    }
